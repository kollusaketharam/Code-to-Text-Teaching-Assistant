...
export const callApi = async (action, body) => {
  // Use the environment variable for the API URL. This is the correct way.
  const API_URL = process.env.REACT_APP_API_URL;

  // Check if the API_URL is defined. If not, it's a configuration error.
  if (!API_URL) {
    throw new Error("Configuration error: REACT_APP_API_URL is not defined in your deployment settings.");
  }
